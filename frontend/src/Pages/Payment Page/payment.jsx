...
const Payment = () => {
  ...
  const initialState = useSelector((store) => store.userReducer);
  console.log("initialState in payment", initialState);
  const ratings = 4;
  // const hotelData=useSelector((store)=>{return store});
  const { tourObj: hotelData } = useSelector(
    (store) => store.tourDetailReducer
  );
  ...
  const displayRazorpay = async (amount) => {
    ...
    const options = {
      ...
      currency: "INR",
      amount: amount * 100,
      name: "Enjoy with Explore Wonders",
      ...
      <>
        ...
        <form id={styles.main_b} onSubmit={handleFormSubmit}>
          <div className={styles.left_div}>
            ...
            <div>
              <div className={`${styles.h2div}`}>
                ...
                <div>
                  <h2>Trip Secure</h2>
                  <p>
                    Trip Secure document will sent to the registered Email ID
                ...
                <div>
                  <div>
                    ...
                    <ul>
                      ...
                      <li>
                        <span className={styles.dot} />
                        Upto ₹ 10K for hotel booking cancellation charges if
                      ...
                      <li>
                        <span className={styles.dot} />
                        Upto ₹ 10K for hotel extension in case of
                        hospitalization
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <div>
                      <div>
                        ...
                        <p>
                          <span style={{ color: "#DC5F00" }}>
                            Non Refundable{" "}
                          </span>
                          | Includes GST
                        </p>
                      </div>
                      <div>{/* <button id="addins">+ Add</button> */}</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              By proceeding, I agree to Explore Wonders Privacy Policy, User
                ...
                <div className={styles.offerDiv}>
                  ...
                  <div>
                    <input
                      ...
                      id="radio-offer"
                      type="radio"
                      defaultValue="Explore Wonders day"
                      disc={30}
                      onClick={(e) => {
                        setPromoCode(e.target.value);
                      }}
                    ...
                    <div>
                      <div>
                        ...
                        <div>
                          - ₹{" "}
                          <span id="discount2">
                            {Math.floor(hotelData.cost * 0.05)}
                          </span>
                        </div>
                      </div>
                      <p>
                        Online Only Offer - Use This Coupon and Get Upto 25%
                        Off!!{" "}
                        <a href="#" style={{ textDecoration: "none" }}>
                          T&amp;C Apply
                        </a>
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <p>
                        Welcome to Explore Wonders! Here is a special offer for you
